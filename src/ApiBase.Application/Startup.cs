...
using ApiBase.Infra.CrossCutting;
using ApiBase.Application.Filters;
using System.Text;
...
namespace ApiBase.Applicationn
{
    public class Startup
    {
        private const string APP_NAME = "API-BASE";
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ApiBase.Application v1"));
            }
            else
            {
